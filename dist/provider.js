...
var HyperWeb3Provider = /** @class */ (function (_super) {
    __extends(HyperWeb3Provider, _super);
    function HyperWeb3Provider(channelKey) {
        var _this = _super.call(this) || this;
        _this.isHyper = true;
        _this.channel = new MessageChannel(channelKey || 'hyper-inpage');
        _this.messenger = new Messenger(_this.channel);
        _this.initEvents();
        return _this;
    }
    HyperWeb3Provider.prototype.request = function (_a) {
    ...
    HyperWeb3Provider.prototype.initEvents = function () {
    ...
    HyperWeb3Provider.prototype.onConnect = function () {
        this.connectedFlag = true;
        this.emit('connect');
    };
    HyperWeb3Provider.prototype.onDisconnect = function (error) {
        this.connectedFlag = false;
        this.emit('disconnect', error);
    };
    HyperWeb3Provider.prototype.onChainChanged = function (chainId) {
        this.emit('chainChanged', chainId);
    };
    HyperWeb3Provider.prototype.onNetworkChanged = function (network) {
        this.emit('networkChanged', network);
    };
    HyperWeb3Provider.prototype.emitAccountsChanged = function (accounts) {
        this.emit('accountsChanged', accounts);
    };
    return HyperWeb3Provider;
}(EventEmitter));
export default HyperWeb3Provider;
